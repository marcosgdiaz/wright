...
class RunStepsWidget(QWidget):
    ...
    def __init__(self, parent: Optional[QWidget] = None) -> None:
        ...
        self._check_electronics = QCheckBox(self)
        self._basic_layout.addRow("Check electronics", self._check_electronics)
    ...
    def model(self) -> RunSteps:
        return RunSteps(
            ...
            check_electronics=self._check_electronics.isChecked(),
        )
    ...
    def setModel(self, model: RunSteps) -> None:
        ...
        self._check_electronics.setChecked(model.check_electronics)
